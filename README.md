# Godot Example Projekt : Possum Game
by [Tea](https://teamakes.games) for the 2025/2026 Winter Semester at HfG.

## 📝 Course Notes
1. [Git Session](https://teamakes.games/and/godot/1/)
2. [Godot Editor Basics, Nodes, Scenes](https://teamakes.games/and/godot/2/)
3. [User Interface & Basic Scripting](https://teamakes.games/and/godot/3/)
4. [Player Character: Movement, Input](https://teamakes.games/and/godot/4/)
5. [Terrain](https://teamakes.games/and/godot/5/)
6. [Items: Collision, Animation, Globals](https://teamakes.games/and/godot/5/)
...
- [manual](https://docs.godotengine.org/en/stable/tutorials/best_practices/index.html) :sparkles:
- [demos](https://godotengine.org/asset-library/asset?user=Godot+Engine) 
External Resources
- GDQuest on [Godot tutorials](https://www.youtube.com/watch?v=yQZKXdwyh-Q)
- [Kids can code](https://kidscancode.org/godot_recipes/4.x/)
